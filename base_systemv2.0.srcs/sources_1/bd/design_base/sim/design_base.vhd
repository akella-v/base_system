...
--Date        : Mon Feb 17 20:45:23 2020
--Host        : Mr406-FT6VUARU running 64-bit major release  (build 9200)
...
entity design_base is
  ...
  attribute CORE_GENERATION_INFO of design_base : entity is "design_base,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_base,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=1,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of design_base : entity is "design_base.hwdef";
end design_base;

architecture STRUCTURE of design_base is
  component design_base_processing_system7_0_0 is
  port (
  ...
  end component design_base_processing_system7_0_0;
...
begin
processing_system7_0: component design_base_processing_system7_0_0
     port map (
